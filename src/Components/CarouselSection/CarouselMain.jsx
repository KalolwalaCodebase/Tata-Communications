      ...
      <Carousel>
          ...
          >
            ...
            >
              ...
              <Link
                target="blank"
                to={
                  "https://www.tatacommunications.com/apps/online-sustainable-development-report-2023/index.php"
                }
                className="view-release-part"
              >
                {/* <Textanimation2 text={''} />    */}view sustainability
        ...
        <Carousel.Item interval={4000}>
          ...
          >
            ...
            >
              <p className="description-last-carosoule">
                Creating a sustainable eco-system by keeping the community at
                the centre of our developmental objectives.
              </p>
              <Link
        ...
        <Carousel.Item>
          <div className="video-conatiner">
            ...
            >
              ...
              <p className="heading-description-carosoule">
                emissions reduction
                <br /> targets validated <br /> by the SBTi
              </p>
              <motion.div className="carosoules-last-container">
                {/* <motion.p
