  ...
  return (
    <Link to={url} className="parent-image-card-component">
      ...
      <div className="image-container-card-heading">
        <motion.h2 initial={{opacity:0,x:"-100px"}} animate={{opacity:1,x:0}} transition={{duration:0.7,ease:"easeInOut"}} className="CardHeading-second-specail poppins-light span-inital">
