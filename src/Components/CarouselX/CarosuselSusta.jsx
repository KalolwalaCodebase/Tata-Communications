        ...
        <div className="carousel-x-container">
            ...
            <div className="carousel-x">
                {data.map((item, index) => (
                    <div
                        key={index}
                        className={`bar ${activeCard === index ? 'activeis' : ''}`}
                    ...
                    >
                        ...
                        {activeCard === index && (
                            <div className="card-x" style={{ backgroundColor: 'white' }}>

                                <table>
                                    <thead>
                                        <h3 style={{ color: item.backgroundColor }} className='poppins-medium card-heading-x'>{item.title}</h3>
                                        <tr>
