      ...
      <div className="climate-change-intro-container people-main-parent-container">
        ...
        >
          <p className="paragraph-inside-climate-change people-paragraph-style1">
            At the heart of our endeavour lies a commitment to empower
            customers, to create ecosystems that enable them to succeed in a new
            world of digital technologies.{" "}
          </p>
          <p className="paragraph-inside-climate-change people-paragraph-style2">
            Our customer success team upholds a customer-centric approach
            throughout the customer journey. They also make sure to align
            internal stakeholders with customer success metrics to make the
      ...
      <div className="planet-climate-last-section-parent">
        <div className="main-section-climate-change">
          ...
          >
            ...
            <h6 className="bigger-paragraph-people-descriptions specail-description-heading">
              At Tata Communications, we are dedicated to enrich the digital
              transformation journey of our customers. Our commitment to
              prioritise customer needs allows us to continuously refine our
              processes and systems. Leveraging the insights gained from
              customer feedback, we drive innovation and introduce new,
              cutting-edge solutions to meet emerging demands effectively.
            </h6>
          </motion.div>
          <motion.div
            initial={{ y: "100px", opacity: 0, scale: 0.5 }}
          ...
          <div
            id="Enhancing-Customer-Engagement"
            className="people-customer-section-deep-pink"
          >
            <motion.b
            ...
            <div class="main-customer-section-design-content">
              <div class="each-container-main-design">
                ...
                <motion.div
                  ...
                  class="slim-pink-container-description"
                >
                  Through various touchpoints and a customer hierarchy, our
                  ‘deeper with fewer’ strategy enhances our relationship with
                  our top 1,000 customers.
                </motion.div>
              </div>
              <div class="each-container-main-design">
                <motion.div
                ...
                <motion.div
                  ...
                  class="slim-pink-container-description"
                >
                  Our Off-Shore Customer Success Management model in Pune uses
                  the follow-the-sun methodology and is geared towards top
              ...
              <div class="each-container-main-design">
                ...
                <motion.div
                  ...
                  class="slim-pink-container-description"
                >
                  Our CRM desk maintains the virtual customer interactions and
                  takes into account customer life cycle management for the
                  sector of digital customers
                </motion.div>
              </div>
              <div class="each-container-main-design">
                <motion.div
                ...
                >
                  {" "}
                  Our dedicated sales team works for the core segment accounts,
                  which are above the top 1,000 accounts. For these accounts, we
                  use the FIGITAL (Field + Digital) paradigm, with distinct
                  responsibilities for account farming and account hunting.
                </motion.div>
              </div>
              <div class="each-container-main-design">
                <motion.div
                ...
                <motion.div
                  ...
                  class="slim-pink-container-description"
                >
                  With the aid of a designated customer success team (CST), our
                  engagement methodology for large enterprise customers focuses
                  on both customer experience and business outcomes.
                </motion.div>
              </div>
            </div>
          </div>
            ...
            <div className="our-ups-card-container">
              <div className="each-card-container-our-ups">
                ...
                <motion.div
                  ...
                  style={{ height: "130px" }}
                >
                  We are able to quickly integrate with the partner ecosystem to
              ...
              <div className="each-card-container-our-ups">
                ...
                <motion.div
                  ...
                  style={{ height: "130px" }}
                >
                  We provided gateways and a network platform to enable the
                  setup of LoRaWAN®{" "}
                </motion.div>
              </div>
              <div className="each-card-container-our-ups">
              ...
              <div className="each-card-container-our-ups">
                ...
                >
                  ...
                  management platform for citywide streetlight management and it
                  is a perfect fit to address our customers’ needs.{" "}
                </motion.div>
              </div>
            </div>
          </div>
        ...
        >
          <b className="heading-links">
            <TextAnimation text={"QUICK"} /> <TextAnimation text={"LINKS"} />
          </b>
          <br />
