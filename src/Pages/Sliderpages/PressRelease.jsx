    ...
    <div>
      ...
      <div className="press-release-description-container">
        ...
        <p className="description-section-main-content">
          ...
          <br />
          <br />
          As part of this, the Company outlines the 3Cs for environment
          ...
          catalysing societal evolution and climate action.”
          <br />
          <br />
        ...
        <p className="small-font-weight-paragraph">
          * Carbon neutral is with respect to Scope 1 and Scope 2 emissions.
          Scope 1 emissions refer to direct emissions from owned or controlled
          sources. Example includes emissions from Diesel Generator sets. Scope
          2 emissions refer to indirect emissions from the generation of
          purchased electricity, i.e., grid electricity.
          <br />
          <br />
        ...
        <br />
        <br />
        <li className="list-press-release">Media contact:</li> <br />
        <div className="address-flex-box-container">
          <div className="addres-splite-into-box">
            ...
            <span className="links-text">
              <a
                ...
                href="mailto:arati.mukerji@tatacommunications.com"
              >
          ...
          <div className="addres-splite-into-box">
            ...
            <span className="links-text">
              <a
                className="no-style-anchor-tag"
                href="mailto:viswa.menon@tatacommunications.com"
              >
        ...
        <b className="small-bold-heading-press-release">
